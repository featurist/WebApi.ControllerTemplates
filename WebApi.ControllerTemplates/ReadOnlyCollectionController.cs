...
{
    public class ReadOnlyCollectionController<TCollection> : AbstractRestController<TCollection>
    {
        private readonly Indexer<TCollection> _indexer;
        private readonly Serialiser<TCollection> _serialiser;

        public ReadOnlyCollectionController(Indexer<TCollection> indexer, Serialiser<TCollection> serialiser)
        {
            _indexer = indexer;
